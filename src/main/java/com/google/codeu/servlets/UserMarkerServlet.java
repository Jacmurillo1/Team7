 ...
 * Responds to user requestssent to the /user-markers URL
 */
...
public class UserMarkerServlet extends HttpServlet {
    ...
    // Sending a GET request gives us JSON array of marker instances
    @Override
    ...
    // Sending a POST request allows us to store a new marker
    @Override
